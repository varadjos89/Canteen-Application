...
/**
 * Created by VARAD on 02/03/2017.
 */

public class BackgroundWorkerForOrder extends AsyncTask<String,Void,String> {

    String result;
    Context context;
    public BackgroundWorkerForOrder(Context ct) {
        context=ct;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String uorder = "https://varadjos88.000webhostapp.com/order.php";
        try {
